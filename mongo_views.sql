...
{
  "_id": "GLOBAL_STD_SRV_ENS_TP_OAS:transformed:General:On-Access Scan",
  "policy_name": "GLOBAL_STD_SRV_ENS_TP_OAS",
  "view_type": "transformed_policy",
  "section": "General",
  "subcategory": "On-Access Scan",
...
{
  "_id": "GLOBAL_STD_SRV_ENS_TP_OAS:application_settings:0",
  "policy_name": "GLOBAL_STD_SRV_ENS_TP_OAS",
  "view_type": "application_settings",
  "chunk_no": 0,
  "rows": [
...
{
  "_id": "GLOBAL_STD_SRV_ENS_TP_OAS:exclusion_settings:default_detection:0",
  "policy_name": "GLOBAL_STD_SRV_ENS_TP_OAS",
  "view_type": "exclusion_settings",
  "exclusion_type": "Default-Detection_Exclusions",
  "chunk_no": 0,
  "rows": [
    {
      "path_extension": "C:\\Program Files\\Tanium\\Tanium Client\\"
    },
    {
      "path_extension": "C:\\Program Files (x86)\\Tanium\\Tanium Client\\"
    }
  ],
  "row_count": 500
}
...
{
  "_id": "GLOBAL_STD_SRV_ENS_TP_OAS:baseline:transformed_policy",
  "policy_name": "GLOBAL_STD_SRV_ENS_TP_OAS",
  "baseline_policy_name": "BASELINE_POLICY",
  "view_type": "transformed_policy",
  "summary": {
...
db.policy_changes.create_index([
    ("policy_name", 1),
    ("baseline_policy_name", 1),
    ("view_type", 1)
])